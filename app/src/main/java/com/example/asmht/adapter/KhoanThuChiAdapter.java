...
public class KhoanThuChiAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            viewOfitem.tvTen = convertView.findViewById(R.id.tv_tenKT);
            viewOfitem.tvTien = convertView.findViewById(R.id.tv_tien);
    ...
    private void showDialogSua(KhoanThuChi khoanThuChi){
        ...
        EditText edtenKT = view.findViewById(R.id.edTenKhoanThu);
        EditText dateKT = view.findViewById(R.id.edNgayThu);
        ...
        edtenKT.setText(khoanThuChi.getTenKhoan());
        dateKT.setText(khoanThuChi.getNgay());
